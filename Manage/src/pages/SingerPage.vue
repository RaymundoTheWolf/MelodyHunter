        ...
        <el-table size="mini" border style="width:100%" height="1050px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="歌手图片" width="110" align="center">
                <template slot-scope="scope">
                    ...
                    <el-upload :action="uploadUrl(scope.row.singer_id)" :before-upload="beforeAvatorUpload" :on-success="handleAvatorSuccess">
            ...
            <el-table-column label="性别" prop="singer_sex" width="50" align="center">
                <template slot-scope="scope">
                    {{ changeSex(scope.row.singer_sex) }}
                </template>
            </el-table-column>
            ...
            <el-table-column label="歌曲管理" width="110" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="songEdit(scope.row.singer_id,scope.row.singer_name)">歌曲管理</el-button>
                </template>
            </el-table-column>
            <el-table-column label="操作" width="150" align="center">
                <template slot-scope="scope">
                    <el-button class="editSinger" size="mini" @click="handleEdit(scope.row)">编辑</el-button>
                    <el-button class="delete" size="mini" @click="handleDelete(scope.row.singer_id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="400px" center>
            <el-form :model="registerForm" ref="registerForm" label-width="80px" :rules="rules">
                ...
                <el-form-item label="性别" size = "mini">
                    ...
                    <input type="radio" name="sex" value="2" v-model="registerForm.sex">&nbsp;未知
                </el-form-item>
...
<script>
import {setSinger , getAllSinger, updateSinger, delSinger, delAll} from '../api/index';
    ...
    watch:{
        select_word: function(){
            ...
            else
            {
                ...
                {
                    if (item.singer_name.includes(this.select_word))
                    {
        ...
        addSinger(){
            this.$refs['registerForm'].validate(valid => {
                if (valid)
                {
                    ...
                    params.append('pic','/img/SingerPic/defaulticon.jpg');

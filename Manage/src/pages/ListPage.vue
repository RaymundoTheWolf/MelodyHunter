        ...
        <el-table size="mini" border style="width:100%" height="1050px" :data="data" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="歌单图片" width="110" align="center">
                <template slot-scope="scope">
                    ...
                    <el-upload :action="uploadUrl(scope.row.list_id)" :before-upload="beforeAvatorUpload" :on-success="handleAvatorSuccess">
            ...
            <el-table-column label="评论" width="120" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="getComment(scope.row.list_id)">评论管理</el-button>
                </template>
            </el-table-column>
            <el-table-column label="歌曲管理" width="110" align="center">
                <template slot-scope="scope">
                    <el-button size="mini" @click="songEdit(scope.row.list_id)">歌曲管理</el-button>
                </template>
            </el-table-column>
            <el-table-column label="操作" width="150" align="center">
                <template slot-scope="scope">
                    <el-button class="editSinger" size="mini" @click="handleEdit(scope.row)">编辑</el-button>
                    <el-button class="delete" size="mini" @click="handleDelete(scope.row.list_id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default{
    ...
    watch:{
        select_word: function(){
            ...
            else
            {
                ...
                {
                    if (item.list_name.includes(this.select_word))
                    {
    ...
    methods:{
        ...
        addSongList(){
            ...
            params.append('cover',"/img/SongListPic/defaultsonglist.jpg")

...
export const mixin = {
    ...
    methods: {
        ...
        attachImageUrl (srcUrl) {
            return srcUrl? this.$store.state.configure.HOST+srcUrl : this.$store.state.configure.HOST+'/img/ClientPic/defaultuser.jpg';
        },
        //根据歌手名字模糊搜索
        getSong() {
        ...
        toPlay: function(id,url,pic,index,name,lyric){
            ...
            localStorage.setItem('lyric',JSON.stringify(this.parseLyric(lyric)));
            if (this.loginIn){
                if (!this.isActive)
